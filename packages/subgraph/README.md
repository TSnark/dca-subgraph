...
Create the entry for the subgraph in a local Graph Node.<br/>

#### `yarn deploy-local`

Deploys the subgraph to a local Graph Node.<br/>

#### `yarn create`

Create the entry for the subgraph in the official Graph Node.<br/>
